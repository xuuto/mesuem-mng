...
<section class="login-content">
    <div class="logo">
{{--        <div class="flex img">--}}
{{--            <img class="table-responsive-sm" src="{{asset('backend/img/museum official logo.png')}}" alt="">--}}
{{--        </div>--}}
        <div class="logo-img" style="display: flex; width: 200px; height:200px; margin: 10px auto;">
            <img class="img-responsive" src="{{asset('backend/img/museum official logo.png')}}" alt="museum logo">
        </div>
        ...
        <form class="login-form" action="{{ route('login') }}" method="POST" role="form">
            ...
            <div class="form-group">
                ...
                <input class="form-control  @error('email') is-invalid @enderror" type="email" id="email" name="email"
                       placeholder="Email address" autofocus value="{{ old('email') }}" required autocomplete="email">
