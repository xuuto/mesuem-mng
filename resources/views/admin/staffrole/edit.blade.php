...
@section('title') Edit Staff-role @endsection
@section('content')
    <div class="app-title">
        <div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                ...
                <form action="{{ route('staff-roles.update', $staffRole) }}" method="post" role="form"
                    ...
                    <div class="tile-body">
                        ...
                        <div class="form-group">
                            <label class="control-label" for="city">Select staff<span
                                        class="m-l-5 text-danger"> *</span></label>
                            ...
                            @error('staff_id') {{ $message }} @enderror
                        </div>
                        ...
                        <div class="form-inline">
                            ...
                            <div class="input-group date">
                                <input type="text" class="form-control" id="datepicker" placeholder="MM/DD/YYYY"
                                       aria-describedby="btn-date" name="role_start" value="{{ \Carbon\Carbon::parse
                                       ($staffRole->role_start)->format('d-m-Y')
                                        }}">
                            ...
                            <div class="input-group date d-inline-flex ml-auto">
                                <label class="control-label mr-2" for="datepicker">Role end Date</label>
                                <input type="text" class="form-control" id="datepicker2" placeholder="MM/DD/YYYY"
                                       aria-describedby="btn-date" name="role_end" value="{{ $staffRole->role_end == true ? \Carbon\Carbon::parse
                                       ($staffRole->role_end)->format('d-m-Y') : null
                                        }}" readonly>
